...
dataloader_test_cancer_images = torch.utils.data.DataLoader(test_cancer_images, batch_size=batch_size,
                                                            shuffle=True, num_workers=num_workers)
dataloader_test_normal_images = torch.utils.data.DataLoader(test_normal_images, batch_size=batch_size,
                                                            shuffle=True, num_workers=num_workers)